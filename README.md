...
11. If yes, the `getMacieFindingsCount` Lambda function runs.
11. If no, the Step Functions Wait state waits 60 seconds and then restarts Step 5.
...
11. If denied, run the `deleteManualReviewS3Files` Lambda function.
11. If approved, run the `moveToScannedDataS3Files` Lambda function.
